...
<span data-ttu-id="3d6f9-113">**[在 CDN 上的第三方文件](#Third-Party_Files_on_the_CDN_23)**</span><span class="sxs-lookup"><span data-stu-id="3d6f9-113">**[Third-Party Files on the CDN](#Third-Party_Files_on_the_CDN_23)**</span></span>  
 ...
 [<span data-ttu-id="3d6f9-114">cdn 的 jQuery 版本</span><span class="sxs-lookup"><span data-stu-id="3d6f9-114">jQuery Releases on the CDN</span></span>](#jQuery_Releases_on_the_CDN_0)  
...
<span data-ttu-id="3d6f9-135">通过利用 CDN，可以显著提高 Ajax 应用程序的性能。</span><span class="sxs-lookup"><span data-stu-id="3d6f9-135">By taking advantage of the CDN, you can significantly improve the performance of your Ajax applications.</span></span> <span data-ttu-id="3d6f9-136">CDN 的内容缓存在位于世界各地的服务器上。</span><span class="sxs-lookup"><span data-stu-id="3d6f9-136">The contents of the CDN are cached on servers located around the world.</span></span> <span data-ttu-id="3d6f9-137">此外，CDN 使浏览器可以重复使用缓存的第三方 JavaScript 文件位于不同域中的网站。</span><span class="sxs-lookup"><span data-stu-id="3d6f9-137">In addition, the CDN enables browsers to reuse cached third party JavaScript files for web sites that are located in different domains.</span></span>
...
#### <a name="jquery-version-320"></a><span data-ttu-id="3d6f9-203">jQuery 版本 3.2.0</span><span class="sxs-lookup"><span data-stu-id="3d6f9-203">jQuery version 3.2.0</span></span>
...
#### <a name="jquery-version-223"></a><span data-ttu-id="3d6f9-208">2.2.3 的 jQuery 版本</span><span class="sxs-lookup"><span data-stu-id="3d6f9-208">jQuery version 2.2.3</span></span>
...
#### <a name="jquery-version-1124"></a><span data-ttu-id="3d6f9-221">jQuery 版本 1.12.4</span><span class="sxs-lookup"><span data-stu-id="3d6f9-221">jQuery version 1.12.4</span></span>
...
#### <a name="jquery-version-1112"></a><span data-ttu-id="3d6f9-227">jQuery 版本 1.11.2</span><span class="sxs-lookup"><span data-stu-id="3d6f9-227">jQuery version 1.11.2</span></span>
...
#### <a name="jquery-version-191"></a><span data-ttu-id="3d6f9-233">jQuery 版本 1.9.1</span><span class="sxs-lookup"><span data-stu-id="3d6f9-233">jQuery version 1.9.1</span></span>
...
- [<span data-ttu-id="3d6f9-278">jQuery UI 1.10.0</span><span class="sxs-lookup"><span data-stu-id="3d6f9-278">jQuery UI 1.10.0</span></span>](jquery-ui/cdnjqueryui1100.md "的 jQuery UI 1.10.0 Microsoft Ajax CDN")
...
- [<span data-ttu-id="3d6f9-299">jQuery UI 1.8.7</span><span class="sxs-lookup"><span data-stu-id="3d6f9-299">jQuery UI 1.8.7</span></span>](jquery-ui/cdnjqueryui187.md "的 jQuery UI 1.8.7 Microsoft Ajax cdn")
...
- [<span data-ttu-id="3d6f9-319">jQuery 验证 1.8</span><span class="sxs-lookup"><span data-stu-id="3d6f9-319">jQuery Validate 1.8</span></span>](jquery-validate/cdnjqueryvalidate18.md "jquery.validate 版本 1.8")
...
- [<span data-ttu-id="3d6f9-339">jQuery Mobile 1.0</span><span class="sxs-lookup"><span data-stu-id="3d6f9-339">jQuery Mobile 1.0</span></span>](jquery-mobile/cdnjquerymobile10.md "的 jQuery Mobile 1.0 Microsoft Ajax CDN")
...
<span data-ttu-id="3d6f9-367">以下版本的[JSHint](http://www.jshint.com "JSHint")托管在 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="3d6f9-367">The following releases of [JSHint](http://www.jshint.com "JSHint") are hosted on the CDN:</span></span>
...
#### <a name="globalize-version-011"></a><span data-ttu-id="3d6f9-373">全球化版本 0.1.1</span><span class="sxs-lookup"><span data-stu-id="3d6f9-373">Globalize version 0.1.1</span></span>

- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/globalize.min.js
- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/globalize.js
- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/cultures/globalize.cultures.js

    - <span data-ttu-id="3d6f9-374">所有区域性</span><span class="sxs-lookup"><span data-stu-id="3d6f9-374">all cultures</span></span>
- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/cultures/globalize.culture.{culture-code}.js

    - <span data-ttu-id="3d6f9-375">"{区域性代码}"替换为所需的区域性代码、 globalize.culture.en GB.js== Microsoft 在 CDN 上的文件例如 = = 这些库已上传由 Microsoft。</span><span class="sxs-lookup"><span data-stu-id="3d6f9-375">Replace "{culture-code}" with the desired culture code, e.g. globalize.culture.en-GB.js== Microsoft Files on the CDN ==These libraries were uploaded by Microsoft.</span></span>

<a id="Respond_Releases_on_the_CDN_13"></a>

### <a name="respond-releases-on-the-cdn"></a><span data-ttu-id="3d6f9-376">响应在 CDN 上的版本</span><span class="sxs-lookup"><span data-stu-id="3d6f9-376">Respond Releases on the CDN</span></span>

<span data-ttu-id="3d6f9-377">以下版本的 [https://github.com/scottjehl/Respond](https://github.com/scottjehl/Respond "https://github.com/scottjehl/Respond") 响应托管在 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="3d6f9-377">The following releases of [https://github.com/scottjehl/Respond](https://github.com/scottjehl/Respond "https://github.com/scottjehl/Respond") Respond are hosted on the CDN:</span></span>

#### <a name="respond-version-142"></a><span data-ttu-id="3d6f9-378">响应版本 1.4.2</span><span class="sxs-lookup"><span data-stu-id="3d6f9-378">Respond version 1.4.2</span></span>
...
#### <a name="respond-version-141"></a><span data-ttu-id="3d6f9-379">响应版本 1.4.1</span><span class="sxs-lookup"><span data-stu-id="3d6f9-379">Respond version 1.4.1</span></span>
...
#### <a name="respond-version-140"></a><span data-ttu-id="3d6f9-380">响应版本.1.4.0</span><span class="sxs-lookup"><span data-stu-id="3d6f9-380">Respond version 1.4.0</span></span>
...
#### <a name="respond-version-130"></a><span data-ttu-id="3d6f9-381">响应版本 1.3.0</span><span class="sxs-lookup"><span data-stu-id="3d6f9-381">Respond version 1.3.0</span></span>

- https://ajax.aspnetcdn.com/ajax/respond/1.3.0/respond.js

#### <a name="respond-version-120"></a><span data-ttu-id="3d6f9-382">响应版本 1.2.0</span><span class="sxs-lookup"><span data-stu-id="3d6f9-382">Respond version 1.2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/respond/1.2.0/respond.js

<a id="Bootstrap_Releases_on_the_CDN_14"></a>

### <a name="bootstrap-releases-on-the-cdn"></a><span data-ttu-id="3d6f9-383">在 CDN 上的 bootstrap 版本</span><span class="sxs-lookup"><span data-stu-id="3d6f9-383">Bootstrap Releases on the CDN</span></span>

<span data-ttu-id="3d6f9-384">以下版本的[getbootstrap.com](http://getbootstrap.com "getbootstrap.com") bootstrap 托管在 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="3d6f9-384">The following releases of [getbootstrap.com](http://getbootstrap.com "getbootstrap.com") bootstrap are hosted on the CDN:</span></span>

#### <a name="bootstrap-version-421"></a><span data-ttu-id="3d6f9-385">Bootstrap 版本 4.2.1</span><span class="sxs-lookup"><span data-stu-id="3d6f9-385">Bootstrap version 4.2.1</span></span>
...
#### <a name="bootstrap-version-411"></a><span data-ttu-id="3d6f9-386">Bootstrap 版 4.1.1</span><span class="sxs-lookup"><span data-stu-id="3d6f9-386">Bootstrap version 4.1.1</span></span>
...
#### <a name="bootstrap-version-400"></a><span data-ttu-id="3d6f9-387">Bootstrap 版本 4.0.0</span><span class="sxs-lookup"><span data-stu-id="3d6f9-387">Bootstrap version 4.0.0</span></span>
...
#### <a name="bootstrap-version-340"></a><span data-ttu-id="3d6f9-388">Bootstrap 版本 3.4.0</span><span class="sxs-lookup"><span data-stu-id="3d6f9-388">Bootstrap version 3.4.0</span></span>
...
#### <a name="bootstrap-version-337"></a><span data-ttu-id="3d6f9-389">Bootstrap 版本 3.3.7</span><span class="sxs-lookup"><span data-stu-id="3d6f9-389">Bootstrap version 3.3.7</span></span>
...
#### <a name="bootstrap-version-336"></a><span data-ttu-id="3d6f9-390">Bootstrap 版本 3.3.6</span><span class="sxs-lookup"><span data-stu-id="3d6f9-390">Bootstrap version 3.3.6</span></span>
...
#### <a name="bootstrap-version-335"></a><span data-ttu-id="3d6f9-391">Bootstrap 版本 3.3.5</span><span class="sxs-lookup"><span data-stu-id="3d6f9-391">Bootstrap version 3.3.5</span></span>
...
#### <a name="bootstrap-version-334"></a><span data-ttu-id="3d6f9-392">3.3.4 bootstrap 版本</span><span class="sxs-lookup"><span data-stu-id="3d6f9-392">Bootstrap version 3.3.4</span></span>
...
#### <a name="bootstrap-version-332"></a><span data-ttu-id="3d6f9-393">3.3.2 bootstrap 版本</span><span class="sxs-lookup"><span data-stu-id="3d6f9-393">Bootstrap version 3.3.2</span></span>
...
#### <a name="bootstrap-version-331"></a><span data-ttu-id="3d6f9-394">3.3.1 bootstrap 版本</span><span class="sxs-lookup"><span data-stu-id="3d6f9-394">Bootstrap version 3.3.1</span></span>
...
#### <a name="bootstrap-version-330"></a><span data-ttu-id="3d6f9-395">Bootstrap 版本 3.3.0</span><span class="sxs-lookup"><span data-stu-id="3d6f9-395">Bootstrap version 3.3.0</span></span>
...
#### <a name="bootstrap-version-320"></a><span data-ttu-id="3d6f9-396">Bootstrap 版本 3.2.0</span><span class="sxs-lookup"><span data-stu-id="3d6f9-396">Bootstrap version 3.2.0</span></span>
...
#### <a name="bootstrap-version-311"></a><span data-ttu-id="3d6f9-397">3.1.1 bootstrap 版本</span><span class="sxs-lookup"><span data-stu-id="3d6f9-397">Bootstrap version 3.1.1</span></span>
...
#### <a name="bootstrap-version-310"></a><span data-ttu-id="3d6f9-398">启动 3.1.0 版</span><span class="sxs-lookup"><span data-stu-id="3d6f9-398">Bootstrap version 3.1.0</span></span>
...
#### <a name="bootstrap-version-303"></a><span data-ttu-id="3d6f9-399">Bootstrap 3.0.3</span><span class="sxs-lookup"><span data-stu-id="3d6f9-399">Bootstrap version 3.0.3</span></span>
...
#### <a name="bootstrap-version-302"></a><span data-ttu-id="3d6f9-400">Bootstrap 版本 3.0.2</span><span class="sxs-lookup"><span data-stu-id="3d6f9-400">Bootstrap version 3.0.2</span></span>
...
#### <a name="bootstrap-version-301"></a><span data-ttu-id="3d6f9-401">Bootstrap 版本 3.0.1</span><span class="sxs-lookup"><span data-stu-id="3d6f9-401">Bootstrap version 3.0.1</span></span>
...
#### <a name="bootstrap-version-300"></a><span data-ttu-id="3d6f9-402">Bootstrap 版本 3.0.0</span><span class="sxs-lookup"><span data-stu-id="3d6f9-402">Bootstrap version 3.0.0</span></span>
...
#### <a name="bootstrap-version-232"></a><span data-ttu-id="3d6f9-403">Bootstrap 版本 2.3.2</span><span class="sxs-lookup"><span data-stu-id="3d6f9-403">Bootstrap version 2.3.2</span></span>
...
#### <a name="bootstrap-version-231"></a><span data-ttu-id="3d6f9-404">Bootstrap 版本 2.3.1</span><span class="sxs-lookup"><span data-stu-id="3d6f9-404">Bootstrap version 2.3.1</span></span>
...
### <a name="bootstrap-touchcarousel-releases-on-the-cdn"></a><span data-ttu-id="3d6f9-405">在 CDN 上的启动 TouchCarousel 版本</span><span class="sxs-lookup"><span data-stu-id="3d6f9-405">Bootstrap TouchCarousel Releases on the CDN</span></span>

<span data-ttu-id="3d6f9-406">以下版本的[https://github.com/ixisio/bootstrap-touch-carousel](https://github.com/ixisio/bootstrap-touch-carousel "https://github.com/ixisio/bootstrap-touch-carousel") Bootstrap TouchCarousel 发布托管在 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="3d6f9-406">The following releases of [https://github.com/ixisio/bootstrap-touch-carousel](https://github.com/ixisio/bootstrap-touch-carousel "https://github.com/ixisio/bootstrap-touch-carousel") Bootstrap TouchCarousel releases are hosted on the CDN:</span></span>

#### <a name="bootstrap-touchcarousel-version-080"></a><span data-ttu-id="3d6f9-407">Bootstrap TouchCarousel 0.8.0 版本开始</span><span class="sxs-lookup"><span data-stu-id="3d6f9-407">Bootstrap TouchCarousel version 0.8.0</span></span>
...
### <a name="hammerjs-releases-on-the-cdn"></a><span data-ttu-id="3d6f9-408">在 CDN 上 Hammer.js 版本</span><span class="sxs-lookup"><span data-stu-id="3d6f9-408">Hammer.js Releases on the CDN</span></span>

<span data-ttu-id="3d6f9-409">以下版本的[http://hammerjs.github.io/](http://hammerjs.github.io/ "http://hammerjs.github.io/") Hammer.js 发布托管在 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="3d6f9-409">The following releases of [http://hammerjs.github.io/](http://hammerjs.github.io/ "http://hammerjs.github.io/") Hammer.js releases are hosted on the CDN:</span></span>

#### <a name="hammerjs-version-204"></a><span data-ttu-id="3d6f9-410">Hammer.js 2.0.4</span><span class="sxs-lookup"><span data-stu-id="3d6f9-410">Hammer.js version 2.0.4</span></span>
...
### <a name="aspnet-web-forms-and-ajax-releases-on-the-cdn"></a><span data-ttu-id="3d6f9-411">ASP.NET Web 窗体和 Ajax cdn 的发行版</span><span class="sxs-lookup"><span data-stu-id="3d6f9-411">ASP.NET Web Forms and Ajax Releases on the CDN</span></span>

<span data-ttu-id="3d6f9-412">在 CDN 上托管以下版本的 ASP.NET Ajax 库。</span><span class="sxs-lookup"><span data-stu-id="3d6f9-412">The following releases of the ASP.NET Ajax Library are hosted on the CDN.</span></span> <span data-ttu-id="3d6f9-413">单击每个链接以查看文件的实际列表。</span><span class="sxs-lookup"><span data-stu-id="3d6f9-413">Click each link to see the actual list of files.</span></span>

- [<span data-ttu-id="3d6f9-414">ASP.NET Web 窗体和 Ajax 版本 4.5.2</span><span class="sxs-lookup"><span data-stu-id="3d6f9-414">ASP.NET Web Forms and Ajax version 4.5.2</span></span>](cdnajax452.md "ASP.NET Web 窗体和 Ajax 4.5.2")
- [<span data-ttu-id="3d6f9-415">ASP.NET Web 窗体和 Ajax 版本 4</span><span class="sxs-lookup"><span data-stu-id="3d6f9-415">ASP.NET Web Forms and Ajax version 4</span></span>](cdnajax4.md "ASP.NET Web 窗体和 Ajax 4")
- [<span data-ttu-id="3d6f9-416">ASP.NET Ajax 版本 3.5</span><span class="sxs-lookup"><span data-stu-id="3d6f9-416">ASP.NET Ajax version 3.5</span></span>](cdnajax35.md "ASP.NET Ajax 3.5")

<a id="ASPNET_MVC_Releases_on_the_CDN_16"></a>

### <a name="aspnet-mvc-releases-on-the-cdn"></a><span data-ttu-id="3d6f9-417">在 CDN 上的 ASP.NET MVC 版本</span><span class="sxs-lookup"><span data-stu-id="3d6f9-417">ASP.NET MVC Releases on the CDN</span></span>

<span data-ttu-id="3d6f9-418">此 CDN 上托管以下 ASP.NET MVC JavaScript 文件：</span><span class="sxs-lookup"><span data-stu-id="3d6f9-418">The following ASP.NET MVC JavaScript files are hosted on this CDN:</span></span>

#### <a name="aspnet-mvc-523"></a><span data-ttu-id="3d6f9-419">ASP.NET MVC 5.2.3</span><span class="sxs-lookup"><span data-stu-id="3d6f9-419">ASP.NET MVC 5.2.3</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.2.3/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.2.3/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-51"></a><span data-ttu-id="3d6f9-420">ASP.NET MVC 5.1</span><span class="sxs-lookup"><span data-stu-id="3d6f9-420">ASP.NET MVC 5.1</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.1/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.1/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-50"></a><span data-ttu-id="3d6f9-421">ASP.NET MVC 5.0</span><span class="sxs-lookup"><span data-stu-id="3d6f9-421">ASP.NET MVC 5.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.0/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.0/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-40"></a><span data-ttu-id="3d6f9-422">ASP.NET MVC 4.0</span><span class="sxs-lookup"><span data-stu-id="3d6f9-422">ASP.NET MVC 4.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/4.0/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/4.0/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-30"></a><span data-ttu-id="3d6f9-423">ASP.NET MVC 3.0</span><span class="sxs-lookup"><span data-stu-id="3d6f9-423">ASP.NET MVC 3.0</span></span>
...
#### <a name="aspnet-mvc-20"></a><span data-ttu-id="3d6f9-424">ASP.NET MVC 2.0</span><span class="sxs-lookup"><span data-stu-id="3d6f9-424">ASP.NET MVC 2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/2.0/MicrosoftMvcAjax.js
- https://ajax.aspnetcdn.com/ajax/mvc/2.0/MicrosoftMvcAjax.debug.js

#### <a name="aspnet-mvc-10"></a><span data-ttu-id="3d6f9-425">ASP.NET MVC 1.0</span><span class="sxs-lookup"><span data-stu-id="3d6f9-425">ASP.NET MVC 1.0</span></span>
...
### <a name="aspnet-signalr-releases-on-the-cdn"></a><span data-ttu-id="3d6f9-426">ASP.NET SignalR 释放 cdn</span><span class="sxs-lookup"><span data-stu-id="3d6f9-426">ASP.NET SignalR Releases on the CDN</span></span>

<span data-ttu-id="3d6f9-427">此 CDN 上托管以下 ASP.NET SignalR JavaScript 文件：</span><span class="sxs-lookup"><span data-stu-id="3d6f9-427">The following ASP.NET SignalR JavaScript files are hosted on this CDN:</span></span>

#### <a name="aspnet-signalr-222"></a><span data-ttu-id="3d6f9-428">ASP.NET SignalR 2.2.2</span><span class="sxs-lookup"><span data-stu-id="3d6f9-428">ASP.NET SignalR 2.2.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.2.js

#### <a name="aspnet-signalr-221"></a><span data-ttu-id="3d6f9-429">ASP.NET SignalR 2.2.1</span><span class="sxs-lookup"><span data-stu-id="3d6f9-429">ASP.NET SignalR 2.2.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.1.js

#### <a name="aspnet-signalr-220"></a><span data-ttu-id="3d6f9-430">ASP.NET SignalR 2.2.0</span><span class="sxs-lookup"><span data-stu-id="3d6f9-430">ASP.NET SignalR 2.2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.0.js

#### <a name="aspnet-signalr-210"></a><span data-ttu-id="3d6f9-431">ASP.NET SignalR 2.1.0</span><span class="sxs-lookup"><span data-stu-id="3d6f9-431">ASP.NET SignalR 2.1.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.1.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.1.0.js

#### <a name="aspnet-signalr-203"></a><span data-ttu-id="3d6f9-432">ASP.NET SignalR 2.0.3</span><span class="sxs-lookup"><span data-stu-id="3d6f9-432">ASP.NET SignalR 2.0.3</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.3.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.3.js

#### <a name="aspnet-signalr-202"></a><span data-ttu-id="3d6f9-433">ASP.NET SignalR 2.0.2</span><span class="sxs-lookup"><span data-stu-id="3d6f9-433">ASP.NET SignalR 2.0.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.2.js

#### <a name="aspnet-signalr-201"></a><span data-ttu-id="3d6f9-434">ASP.NET SignalR 2.0.1</span><span class="sxs-lookup"><span data-stu-id="3d6f9-434">ASP.NET SignalR 2.0.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.1.js

#### <a name="aspnet-signalr-200"></a><span data-ttu-id="3d6f9-435">ASP.NET SignalR 2.0.0</span><span class="sxs-lookup"><span data-stu-id="3d6f9-435">ASP.NET SignalR 2.0.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.0.js

#### <a name="aspnet-signalr-113"></a><span data-ttu-id="3d6f9-436">ASP.NET SignalR 1.1.3</span><span class="sxs-lookup"><span data-stu-id="3d6f9-436">ASP.NET SignalR 1.1.3</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.3.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.3.js

#### <a name="aspnet-signalr-112"></a><span data-ttu-id="3d6f9-437">ASP.NET SignalR 1.1.2</span><span class="sxs-lookup"><span data-stu-id="3d6f9-437">ASP.NET SignalR 1.1.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.2.js

#### <a name="aspnet-signalr-111"></a><span data-ttu-id="3d6f9-438">ASP.NET SignalR 1.1.1</span><span class="sxs-lookup"><span data-stu-id="3d6f9-438">ASP.NET SignalR 1.1.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.1.js

#### <a name="aspnet-signalr-110"></a><span data-ttu-id="3d6f9-439">ASP.NET SignalR 1.1.0</span><span class="sxs-lookup"><span data-stu-id="3d6f9-439">ASP.NET SignalR 1.1.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.0.js

#### <a name="aspnet-signalr-101"></a><span data-ttu-id="3d6f9-440">ASP.NET SignalR 1.0.1</span><span class="sxs-lookup"><span data-stu-id="3d6f9-440">ASP.NET SignalR 1.0.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.0.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.0.1.js

<span data-ttu-id="3d6f9-441">有关为 CDN 使用条款的信息，请参阅[Microsoft Ajax CDN 使用条款](https://www.asp.net/terms-of-use "Microsoft Ajax CDN 使用条款")。</span><span class="sxs-lookup"><span data-stu-id="3d6f9-441">For information about the terms of use for the CDN, see [Microsoft Ajax CDN Terms of Use](https://www.asp.net/terms-of-use "Microsoft Ajax CDN Terms of Use").</span></span>
