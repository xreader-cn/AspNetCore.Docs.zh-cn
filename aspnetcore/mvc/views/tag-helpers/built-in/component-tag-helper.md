...
> [!NOTE]
> <span data-ttu-id="2083e-110">在 Razor Razor .net 5.0 或更高版本的 ASP.NET Core 中支持将组件集成到 *托管 Blazor WebAssembly 应用* 中的页面和 MVC 应用。</span><span class="sxs-lookup"><span data-stu-id="2083e-110">Integrating Razor components into Razor Pages and MVC apps in a *hosted Blazor WebAssembly app* is supported in ASP.NET Core in .NET 5.0 or later.</span></span>
...
* <span data-ttu-id="2083e-113">在页面上呈现为静态 HTML，或者包含从用户代理启动 Blazor 应用所需的信息。</span><span class="sxs-lookup"><span data-stu-id="2083e-113">Is rendered as static HTML on the page or if it includes the necessary information to bootstrap a Blazor app from the user agent.</span></span>

::: moniker range=">= aspnetcore-5.0"

<span data-ttu-id="2083e-114">Blazor WebAssembly 应用呈现模式如下表中所示。</span><span class="sxs-lookup"><span data-stu-id="2083e-114">Blazor WebAssembly app render modes are shown in the following table.</span></span>
...
| ----------- | ----------- |
| `WebAssembly` | <span data-ttu-id="2083e-117">呈现应用程序的标记，以便在 Blazor WebAssembly 浏览器中加载时包含交互组件。</span><span class="sxs-lookup"><span data-stu-id="2083e-117">Renders a marker for a Blazor WebAssembly app for use to include an interactive component when loaded in the browser.</span></span> <span data-ttu-id="2083e-118">组件未预呈现。</span><span class="sxs-lookup"><span data-stu-id="2083e-118">The component isn't prerendered.</span></span> <span data-ttu-id="2083e-119">此选项使你可以更轻松地 Blazor WebAssembly 在不同的页面上呈现不同的组件。</span><span class="sxs-lookup"><span data-stu-id="2083e-119">This option makes it easier to render different Blazor WebAssembly components on different pages.</span></span> |
| `WebAssemblyPrerendered` | <span data-ttu-id="2083e-120">将组件 Prerenders 为静态 HTML，并包含 Blazor WebAssembly 应用的标记，以便在浏览器中加载时使组件成为交互组件。</span><span class="sxs-lookup"><span data-stu-id="2083e-120">Prerenders the component into static HTML and includes a marker for a Blazor WebAssembly app for later use to make the component interactive when loaded in the browser.</span></span> |

<span data-ttu-id="2083e-121">Blazor Server 应用呈现模式如下表中所示。</span><span class="sxs-lookup"><span data-stu-id="2083e-121">Blazor Server app render modes are shown in the following table.</span></span>
...
| ----------- | ----------- |
| <xref:Microsoft.AspNetCore.Mvc.Rendering.RenderMode.ServerPrerendered> | <span data-ttu-id="2083e-124">在静态 HTML 中呈现组件，并包含 Blazor Server 应用的标记。</span><span class="sxs-lookup"><span data-stu-id="2083e-124">Renders the component into static HTML and includes a marker for a Blazor Server app.</span></span> <span data-ttu-id="2083e-125">用户代理启动时，此标记用于启动 Blazor 应用。</span><span class="sxs-lookup"><span data-stu-id="2083e-125">When the user-agent starts, this marker is used to bootstrap a Blazor app.</span></span> |
| <xref:Microsoft.AspNetCore.Mvc.Rendering.RenderMode.Server> | <span data-ttu-id="2083e-126">呈现 Blazor Server 应用的标记。</span><span class="sxs-lookup"><span data-stu-id="2083e-126">Renders a marker for a Blazor Server app.</span></span> <span data-ttu-id="2083e-127">不包括组件的输出。</span><span class="sxs-lookup"><span data-stu-id="2083e-127">Output from the component isn't included.</span></span> <span data-ttu-id="2083e-128">用户代理启动时，此标记用于启动 Blazor 应用。</span><span class="sxs-lookup"><span data-stu-id="2083e-128">When the user-agent starts, this marker is used to bootstrap a Blazor app.</span></span> |
...
<span data-ttu-id="2083e-130">Blazor Server 应用呈现模式如下表中所示。</span><span class="sxs-lookup"><span data-stu-id="2083e-130">Blazor Server app render modes are shown in the following table.</span></span>
...
| ----------- | ----------- |
| <xref:Microsoft.AspNetCore.Mvc.Rendering.RenderMode.ServerPrerendered> | <span data-ttu-id="2083e-133">在静态 HTML 中呈现组件，并包含 Blazor Server 应用的标记。</span><span class="sxs-lookup"><span data-stu-id="2083e-133">Renders the component into static HTML and includes a marker for a Blazor Server app.</span></span> <span data-ttu-id="2083e-134">用户代理启动时，此标记用于启动 Blazor 应用。</span><span class="sxs-lookup"><span data-stu-id="2083e-134">When the user-agent starts, this marker is used to bootstrap a Blazor app.</span></span> |
| <xref:Microsoft.AspNetCore.Mvc.Rendering.RenderMode.Server> | <span data-ttu-id="2083e-135">呈现 Blazor Server 应用的标记。</span><span class="sxs-lookup"><span data-stu-id="2083e-135">Renders a marker for a Blazor Server app.</span></span> <span data-ttu-id="2083e-136">不包括组件的输出。</span><span class="sxs-lookup"><span data-stu-id="2083e-136">Output from the component isn't included.</span></span> <span data-ttu-id="2083e-137">用户代理启动时，此标记用于启动 Blazor 应用。</span><span class="sxs-lookup"><span data-stu-id="2083e-137">When the user-agent starts, this marker is used to bootstrap a Blazor app.</span></span> |
...
* <span data-ttu-id="2083e-140">允许多个组件标记帮助器呈现多个 Razor 组件。</span><span class="sxs-lookup"><span data-stu-id="2083e-140">Multiple Component Tag Helpers rendering multiple Razor components is allowed.</span></span>
...
<span data-ttu-id="2083e-146">以下组件标记帮助程序使用以下组件在 `Counter` 应用程序的页面或视图中呈现组件 Blazor Server `ServerPrerendered` ：</span><span class="sxs-lookup"><span data-stu-id="2083e-146">The following Component Tag Helper renders the `Counter` component in a page or view in a Blazor Server app with `ServerPrerendered`:</span></span>
...
<span data-ttu-id="2083e-155">传递带引号的字符串需要 [显式 Razor 表达式](xref:mvc/views/razor#explicit-razor-expressions)，如 `param-Color` 前面的示例中所示。</span><span class="sxs-lookup"><span data-stu-id="2083e-155">Passing a quoted string requires an [explicit Razor expression](xref:mvc/views/razor#explicit-razor-expressions), as shown for `param-Color` in the preceding example.</span></span> <span data-ttu-id="2083e-156">Razor `string` 由于属性是类型，因此类型值的分析行为不适用于 `param-*` 特性 `object` 。</span><span class="sxs-lookup"><span data-stu-id="2083e-156">The Razor parsing behavior for a `string` type value doesn't apply to a `param-*` attribute because the attribute is an `object` type.</span></span>
...
* <span data-ttu-id="2083e-161">其类型在 Blazor WebAssembly 应用外或延迟加载的程序集中定义的参数。</span><span class="sxs-lookup"><span data-stu-id="2083e-161">Parameters whose type is defined outside of the Blazor WebAssembly app or within a lazily-loaded assembly.</span></span>
...
<span data-ttu-id="2083e-169">前面的示例假定 `MyComponent` 组件位于应用的 *共享* 文件夹中。</span><span class="sxs-lookup"><span data-stu-id="2083e-169">The preceding example assumes that the `MyComponent` component is in the app's *Shared* folder.</span></span> <span data-ttu-id="2083e-170">占位符 `{APP ASSEMBLY}` 是应用程序的程序集名称 (例如， `@using BlazorSample` `@using BlazorSample.Shared`) 。</span><span class="sxs-lookup"><span data-stu-id="2083e-170">The placeholder `{APP ASSEMBLY}` is the app's assembly name (for example, `@using BlazorSample` and `@using BlazorSample.Shared`).</span></span> <span data-ttu-id="2083e-171">`MyClass` 在应用的命名空间中。</span><span class="sxs-lookup"><span data-stu-id="2083e-171">`MyClass` is in the app's namespace.</span></span>
