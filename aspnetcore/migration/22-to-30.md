...
* Entity Framework Core-有关 https://docs.microsoft.com/en-us/ef/core/providers/index 引用数据库提供程序特定包的详细信息，请参阅。
...
为 MVC 提供 UI 组件的 Razor 类库项目必须在项目文件`RazorLangVersion`中设置属性。
...
有关3.0 版本中的其他重大更改，请参阅公告存储库 https://github.com/aspnet/Announcements/issues?page=2&q=is%3Aissue+is%3Aopen+label%3A%22Breaking+change%22+label%3A3.0.0 -。
