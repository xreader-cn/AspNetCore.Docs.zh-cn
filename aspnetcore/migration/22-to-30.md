...
#### <a name="framework-dependent-builds-using-docker"></a>使用 Docker 的框架依赖生成

使用依赖于 ASP.NET Core[共享框架](https://natemcmaster.com/blog/2018/08/29/netcore-primitives-2/)的包的依赖于框架的控制台应用程序版本可能会导致以下运行时错误：
...
## <a name="mysqldataentityframeworkcore-currently-not-supported-on-aspnet-core-30"></a>ASP.NET Core 3.0 上当前不支持 Microsoft.entityframeworkcore
