...
ASP.NET Core 2.1 提供[ASP.NET Core Identity ](xref:security/authentication/identity)作为类库[ Razor (RCL](xref:razor-pages/ui-class)) 。
...
### <a name="update-after-scaffolding-no-locidentity"></a>在基架之后更新Identity
