...
## <a name="samesite-and-no-locidentity"></a>SameSite 和Identity
...
| [Cookie验证](xref:Microsoft.Extensions.DependencyInjection.CookieExtensions.AddCookie*) | [CookieAuthenticationOptions.Cookie](xref:Microsoft.AspNetCore.Builder.CookieAuthenticationOptions.CookieName) | `Lax` |
...
### <a name="test-with-no-locelectron"></a>测试Electron
