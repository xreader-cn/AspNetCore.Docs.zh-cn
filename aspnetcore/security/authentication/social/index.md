...
<span data-ttu-id="c3469-108">让用户使用其现有凭据登录的好处：</span><span class="sxs-lookup"><span data-stu-id="c3469-108">Enabling users to sign in with their existing credentials:</span></span>
