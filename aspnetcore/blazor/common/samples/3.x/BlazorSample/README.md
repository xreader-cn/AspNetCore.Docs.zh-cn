# <a name="blazor-webassembly-sample-app"></a><span data-ttu-id="968c2-101">Blazor WebAssembly 示例应用</span><span class="sxs-lookup"><span data-stu-id="968c2-101">Blazor WebAssembly Sample App</span></span>
