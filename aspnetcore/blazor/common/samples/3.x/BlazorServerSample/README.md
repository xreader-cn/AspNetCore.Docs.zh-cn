# <a name="blazor-server-sample-app"></a><span data-ttu-id="d81c0-101">Blazor Server 示例应用</span><span class="sxs-lookup"><span data-stu-id="d81c0-101">Blazor Server Sample App</span></span>
