# <a name="blazor-webassembly-sample-app"></a><span data-ttu-id="c2292-101">Blazor WebAssembly 示例应用</span><span class="sxs-lookup"><span data-stu-id="c2292-101">Blazor WebAssembly Sample App</span></span>
