# <a name="blazor-webassembly-sample-app"></a><span data-ttu-id="cc9e3-101">Blazor WebAssembly 示例应用</span><span class="sxs-lookup"><span data-stu-id="cc9e3-101">Blazor WebAssembly Sample App</span></span>
