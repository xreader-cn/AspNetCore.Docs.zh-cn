# <a name="blazor-webassembly-sample-app"></a><span data-ttu-id="07623-101">Blazor WebAssembly 示例应用</span><span class="sxs-lookup"><span data-stu-id="07623-101">Blazor WebAssembly Sample App</span></span>
