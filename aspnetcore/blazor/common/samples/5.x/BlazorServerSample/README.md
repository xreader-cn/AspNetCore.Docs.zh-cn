# <a name="blazor-server-sample-app"></a><span data-ttu-id="5e030-101">Blazor Server 示例应用</span><span class="sxs-lookup"><span data-stu-id="5e030-101">Blazor Server Sample App</span></span>
