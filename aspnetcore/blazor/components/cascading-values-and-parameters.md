...
---
# <a name="aspnet-core-no-locblazor-cascading-values-and-parameters"></a><span data-ttu-id="08f1f-103">ASP.NET Core Blazor 级联值和参数</span><span class="sxs-lookup"><span data-stu-id="08f1f-103">ASP.NET Core Blazor cascading values and parameters</span></span>
...
### <a name="theme-example"></a><span data-ttu-id="08f1f-109">主题示例</span><span class="sxs-lookup"><span data-stu-id="08f1f-109">Theme example</span></span>
