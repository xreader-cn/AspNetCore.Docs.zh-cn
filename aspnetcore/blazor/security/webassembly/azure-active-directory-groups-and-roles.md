...
<span data-ttu-id="d20e6-113">本文中的指南适用于以下主题中所述的 :::no-loc(Blazor WebAssembly)::: AAD 部署方案：</span><span class="sxs-lookup"><span data-stu-id="d20e6-113">The guidance in this article applies to the :::no-loc(Blazor WebAssembly)::: AAD deployment scenarios described in the following topics:</span></span>
...
<span data-ttu-id="d20e6-126">以下示例假定用户被分配到 AAD 计费管理员角色。</span><span class="sxs-lookup"><span data-stu-id="d20e6-126">The following examples assume that a user is assigned to the AAD *Billing Administrator* role.</span></span>
...
* [<span data-ttu-id="d20e6-137">使用 Graph SDK</span><span class="sxs-lookup"><span data-stu-id="d20e6-137">Use the Graph SDK</span></span>](#use-the-graph-sdk)
...
<span data-ttu-id="d20e6-146">上面的代码不包含可传递的成员身份。</span><span class="sxs-lookup"><span data-stu-id="d20e6-146">The preceding code doesn't include transitive memberships.</span></span> <span data-ttu-id="d20e6-147">如果应用需要直接和可传递的组成员身份声明，请执行以下操作：</span><span class="sxs-lookup"><span data-stu-id="d20e6-147">If the app requires direct and transitive group membership claims:</span></span>
...
<span data-ttu-id="d20e6-154">`GraphAPIAuthorizationMessageHandler.cs`:</span><span class="sxs-lookup"><span data-stu-id="d20e6-154">`GraphAPIAuthorizationMessageHandler.cs`:</span></span>
...
<span data-ttu-id="d20e6-174">为 `Program.Main` 中的每个组或角色创建[策略](xref:security/authorization/policies)。</span><span class="sxs-lookup"><span data-stu-id="d20e6-174">Create a [policy](xref:security/authorization/policies) for each group or role in `Program.Main`.</span></span> <span data-ttu-id="d20e6-175">以下示例为 AAD 计费管理员角色创建策略：</span><span class="sxs-lookup"><span data-stu-id="d20e6-175">The following example creates a policy for the AAD *Billing Administrator* role:</span></span>
...
<span data-ttu-id="d20e6-180">如果用户未登录，则会将他们重定向到 AAD 登录页，然后在他们登录后再返回到组件。</span><span class="sxs-lookup"><span data-stu-id="d20e6-180">If the user isn't logged in, they're redirected to the AAD sign-in page and then back to the component after they sign in.</span></span>
...
* <span data-ttu-id="d20e6-185">服务器 API 应用使用用户的不可变[对象标识符声明 (`oid`)](/azure/active-directory/develop/id-tokens#payload-claims)（来自访问令牌）来获取 Graph API 的访问令牌。</span><span class="sxs-lookup"><span data-stu-id="d20e6-185">The server API app uses the user's immutable [object identifier claim (`oid`)](/azure/active-directory/develop/id-tokens#payload-claims) from their access token to obtain an access token for Graph API.</span></span>
...
### <a name="app-settings"></a><span data-ttu-id="d20e6-202">应用设置</span><span class="sxs-lookup"><span data-stu-id="d20e6-202">App settings</span></span>
...
### <a name="controller-access"></a><span data-ttu-id="d20e6-217">控制器访问</span><span class="sxs-lookup"><span data-stu-id="d20e6-217">Controller access</span></span>
...
<span data-ttu-id="d20e6-227">配置 <xref:Microsoft.AspNetCore.Authentication.JwtBearer.JwtBearerEvents> 时：</span><span class="sxs-lookup"><span data-stu-id="d20e6-227">When configuring <xref:Microsoft.AspNetCore.Authentication.JwtBearer.JwtBearerEvents>:</span></span>
...
<span data-ttu-id="d20e6-234">在上面的代码中，可选择处理以下令牌错误：</span><span class="sxs-lookup"><span data-stu-id="d20e6-234">In the preceding code, handling the following token errors is optional:</span></span>
...
* <span data-ttu-id="d20e6-264">对于代码行：</span><span class="sxs-lookup"><span data-stu-id="d20e6-264">For the code line:</span></span>
...
<span data-ttu-id="d20e6-272">还可以将 AAD 注册应用配置为使用用户定义的角色。</span><span class="sxs-lookup"><span data-stu-id="d20e6-272">An AAD-registered app can also be configured to use user-defined roles.</span></span>
...
<span data-ttu-id="d20e6-354">消息中心隐私读取者</span><span class="sxs-lookup"><span data-stu-id="d20e6-354">Message center privacy reader</span></span> | <span data-ttu-id="d20e6-355">6395db95-9fb8-42b9-b1ed-30a2405eee6f</span><span class="sxs-lookup"><span data-stu-id="d20e6-355">6395db95-9fb8-42b9-b1ed-30a2405eee6f</span></span>
<span data-ttu-id="d20e6-356">消息中心读取者</span><span class="sxs-lookup"><span data-stu-id="d20e6-356">Message center reader</span></span> | <span data-ttu-id="d20e6-357">fd5d37b8-4e24-434b-9e63-70ed3b759a16</span><span class="sxs-lookup"><span data-stu-id="d20e6-357">fd5d37b8-4e24-434b-9e63-70ed3b759a16</span></span>
<span data-ttu-id="d20e6-358">Office 应用管理员</span><span class="sxs-lookup"><span data-stu-id="d20e6-358">Office apps administrator</span></span> | <span data-ttu-id="d20e6-359">5f3870cd-b042-4f93-86d7-c9d77c664dc7</span><span class="sxs-lookup"><span data-stu-id="d20e6-359">5f3870cd-b042-4f93-86d7-c9d77c664dc7</span></span>
<span data-ttu-id="d20e6-360">密码管理员</span><span class="sxs-lookup"><span data-stu-id="d20e6-360">Password administrator</span></span> | <span data-ttu-id="d20e6-361">466e48b7-5d66-4ae5-8911-1a118de74941</span><span class="sxs-lookup"><span data-stu-id="d20e6-361">466e48b7-5d66-4ae5-8911-1a118de74941</span></span>
<span data-ttu-id="d20e6-362">Power BI 管理员</span><span class="sxs-lookup"><span data-stu-id="d20e6-362">Power BI administrator</span></span> | <span data-ttu-id="d20e6-363">984e83b8-8337-4255-91a1-acb663175ab4</span><span class="sxs-lookup"><span data-stu-id="d20e6-363">984e83b8-8337-4255-91a1-acb663175ab4</span></span>
<span data-ttu-id="d20e6-364">Power Platform 管理员</span><span class="sxs-lookup"><span data-stu-id="d20e6-364">Power platform administrator</span></span> | <span data-ttu-id="d20e6-365">76d6f95e-9a15-4d7d-8d21-00de00faf9fd</span><span class="sxs-lookup"><span data-stu-id="d20e6-365">76d6f95e-9a15-4d7d-8d21-00de00faf9fd</span></span>
<span data-ttu-id="d20e6-366">特权身份验证管理员</span><span class="sxs-lookup"><span data-stu-id="d20e6-366">Privileged authentication administrator</span></span> | <span data-ttu-id="d20e6-367">0829f731-b46d-419f-9742-aeb122367d11</span><span class="sxs-lookup"><span data-stu-id="d20e6-367">0829f731-b46d-419f-9742-aeb122367d11</span></span>
<span data-ttu-id="d20e6-368">特权角色管理员</span><span class="sxs-lookup"><span data-stu-id="d20e6-368">Privileged role administrator</span></span> | <span data-ttu-id="d20e6-369">f20a725a-d1c8-4107-83ea-1171c97d00c7</span><span class="sxs-lookup"><span data-stu-id="d20e6-369">f20a725a-d1c8-4107-83ea-1171c97d00c7</span></span>
<span data-ttu-id="d20e6-370">报告读者</span><span class="sxs-lookup"><span data-stu-id="d20e6-370">Reports reader</span></span> | <span data-ttu-id="d20e6-371">54635450-e8ed-4f2d-9632-07db2517b4de</span><span class="sxs-lookup"><span data-stu-id="d20e6-371">54635450-e8ed-4f2d-9632-07db2517b4de</span></span>
<span data-ttu-id="d20e6-372">搜索管理员</span><span class="sxs-lookup"><span data-stu-id="d20e6-372">Search administrator</span></span> | <span data-ttu-id="d20e6-373">c770a2f1-c9ba-4e60-9176-9f52b1eb1a31</span><span class="sxs-lookup"><span data-stu-id="d20e6-373">c770a2f1-c9ba-4e60-9176-9f52b1eb1a31</span></span>
<span data-ttu-id="d20e6-374">搜索编辑员</span><span class="sxs-lookup"><span data-stu-id="d20e6-374">Search editor</span></span> | <span data-ttu-id="d20e6-375">6a6858c6-5f0d-44ac-87c7-0190fbedd271</span><span class="sxs-lookup"><span data-stu-id="d20e6-375">6a6858c6-5f0d-44ac-87c7-0190fbedd271</span></span>
<span data-ttu-id="d20e6-376">安全管理员</span><span class="sxs-lookup"><span data-stu-id="d20e6-376">Security administrator</span></span> | <span data-ttu-id="d20e6-377">20fa50e3-6531-44d8-bd39-b251420568ad</span><span class="sxs-lookup"><span data-stu-id="d20e6-377">20fa50e3-6531-44d8-bd39-b251420568ad</span></span>
<span data-ttu-id="d20e6-378">安全操作员</span><span class="sxs-lookup"><span data-stu-id="d20e6-378">Security operator</span></span> | <span data-ttu-id="d20e6-379">43aae017-8e51-4188-91ab-e6debd572800</span><span class="sxs-lookup"><span data-stu-id="d20e6-379">43aae017-8e51-4188-91ab-e6debd572800</span></span>
<span data-ttu-id="d20e6-380">安全读取者</span><span class="sxs-lookup"><span data-stu-id="d20e6-380">Security reader</span></span> | <span data-ttu-id="d20e6-381">45035cd3-fd97-4250-8197-3a53d3562d9b</span><span class="sxs-lookup"><span data-stu-id="d20e6-381">45035cd3-fd97-4250-8197-3a53d3562d9b</span></span>
<span data-ttu-id="d20e6-382">服务支持管理员</span><span class="sxs-lookup"><span data-stu-id="d20e6-382">Service support administrator</span></span> | <span data-ttu-id="d20e6-383">2c92cf45-c914-48f8-9bf9-fc14b28818ab</span><span class="sxs-lookup"><span data-stu-id="d20e6-383">2c92cf45-c914-48f8-9bf9-fc14b28818ab</span></span>
<span data-ttu-id="d20e6-384">SharePoint 管理员</span><span class="sxs-lookup"><span data-stu-id="d20e6-384">SharePoint administrator</span></span> | <span data-ttu-id="d20e6-385">e1c32229-875e-461d-ae24-3cb99116e86c</span><span class="sxs-lookup"><span data-stu-id="d20e6-385">e1c32229-875e-461d-ae24-3cb99116e86c</span></span>
<span data-ttu-id="d20e6-386">Skype for Business 管理员</span><span class="sxs-lookup"><span data-stu-id="d20e6-386">Skype for Business administrator</span></span> | <span data-ttu-id="d20e6-387">0a8cee12-e21d-43ef-abd9-f1ea85710e30</span><span class="sxs-lookup"><span data-stu-id="d20e6-387">0a8cee12-e21d-43ef-abd9-f1ea85710e30</span></span>
<span data-ttu-id="d20e6-388">Teams 通信管理员</span><span class="sxs-lookup"><span data-stu-id="d20e6-388">Teams Communications Administrator</span></span> | <span data-ttu-id="d20e6-389">2393e455-6e13-4743-9f52-63fcec2b6a9c</span><span class="sxs-lookup"><span data-stu-id="d20e6-389">2393e455-6e13-4743-9f52-63fcec2b6a9c</span></span>
<span data-ttu-id="d20e6-390">Teams 通信支持工程师</span><span class="sxs-lookup"><span data-stu-id="d20e6-390">Teams Communications Support Engineer</span></span> | <span data-ttu-id="d20e6-391">802dd94e-d717-46f6-af98-b9167071e9fc</span><span class="sxs-lookup"><span data-stu-id="d20e6-391">802dd94e-d717-46f6-af98-b9167071e9fc</span></span>
<span data-ttu-id="d20e6-392">Teams 通信专家</span><span class="sxs-lookup"><span data-stu-id="d20e6-392">Teams Communications Specialist</span></span> | <span data-ttu-id="d20e6-393">ef547281-cf46-4cc6-bcaa-f5eac3f030c9</span><span class="sxs-lookup"><span data-stu-id="d20e6-393">ef547281-cf46-4cc6-bcaa-f5eac3f030c9</span></span>
<span data-ttu-id="d20e6-394">Teams 服务管理员</span><span class="sxs-lookup"><span data-stu-id="d20e6-394">Teams Service Administrator</span></span> | <span data-ttu-id="d20e6-395">8846a0be-197b-443a-b13c-11192691fa24</span><span class="sxs-lookup"><span data-stu-id="d20e6-395">8846a0be-197b-443a-b13c-11192691fa24</span></span>
<span data-ttu-id="d20e6-396">用户管理员</span><span class="sxs-lookup"><span data-stu-id="d20e6-396">User administrator</span></span> | <span data-ttu-id="d20e6-397">1f6eed58-7dd3-460b-a298-666f975427a1</span><span class="sxs-lookup"><span data-stu-id="d20e6-397">1f6eed58-7dd3-460b-a298-666f975427a1</span></span>

## <a name="additional-resources"></a><span data-ttu-id="d20e6-398">其他资源</span><span class="sxs-lookup"><span data-stu-id="d20e6-398">Additional resources</span></span>
