...
1. 从“名称”列（例如 Blazor 服务器 AAD B2C）中选择“服务器 API 应用”****** ****。
1. 打开 API 列表****。
...
[Microsoft.AspNetCore.Authentication.AzureADB2C.UI](https://www.nuget.org/packages/Microsoft.AspNetCore.Authentication.AzureADB2C.UI/) 包提供对 ASP.NET Core Web API 的身份验证和授权调用的支持：
