...
* 当匿名用户选择登录按钮或请求应用了 [`[Authorize]` 特性](xref:Microsoft.AspNetCore.Authorization.AuthorizeAttribute)的页面时，该用户将重定向到应用的登录页 (`/authentication/login`)。
