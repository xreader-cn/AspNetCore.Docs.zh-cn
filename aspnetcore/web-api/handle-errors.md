...
1. <span data-ttu-id="5e2d6-135">将属性路由应用于控制器操作：</span><span class="sxs-lookup"><span data-stu-id="5e2d6-135">Apply attribute routing to controller actions:</span></span>
