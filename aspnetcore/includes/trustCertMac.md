<span data-ttu-id="f8630-101">Visual Studio for Mac 显示对话框，其中显示以下消息：</span><span class="sxs-lookup"><span data-stu-id="f8630-101">Visual Studio for Mac displays a dialog with the following message:</span></span>
