<span data-ttu-id="ce413-101">Visual Studio for Mac 会显示以下弹出窗口：</span><span class="sxs-lookup"><span data-stu-id="ce413-101">Visual Studio for Mac displays the following popup:</span></span>
