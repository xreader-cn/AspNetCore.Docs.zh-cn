### <a name="view-the-identity-database"></a><span data-ttu-id="c12cd-101">查看标识数据库</span><span class="sxs-lookup"><span data-stu-id="c12cd-101">View the Identity database</span></span>
