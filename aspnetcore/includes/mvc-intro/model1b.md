<span data-ttu-id="0f234-101">向 `Movie` 类添加以下属性：</span><span class="sxs-lookup"><span data-stu-id="0f234-101">Add the following properties to the `Movie` class:</span></span>
