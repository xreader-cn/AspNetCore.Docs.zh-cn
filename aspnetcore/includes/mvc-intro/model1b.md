<span data-ttu-id="331f7-101">向 `Movie` 类添加以下属性：</span><span class="sxs-lookup"><span data-stu-id="331f7-101">Add the following properties to the `Movie` class:</span></span>
