<span data-ttu-id="fe0bd-101">向 `Movie` 类添加以下属性：</span><span class="sxs-lookup"><span data-stu-id="fe0bd-101">Add the following properties to the `Movie` class:</span></span>
