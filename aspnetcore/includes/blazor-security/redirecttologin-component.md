<span data-ttu-id="993b8-101">`RedirectToLogin`组件（*Shared/RedirectToLogin*）：</span><span class="sxs-lookup"><span data-stu-id="993b8-101">The `RedirectToLogin` component (*Shared/RedirectToLogin.razor*):</span></span>
