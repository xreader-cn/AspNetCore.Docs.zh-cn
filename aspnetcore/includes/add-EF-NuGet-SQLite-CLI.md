<span data-ttu-id="7b4ba-101">运行以下 .NET Core CLI 命令：</span><span class="sxs-lookup"><span data-stu-id="7b4ba-101">Run the following .NET Core CLI commands:</span></span>
