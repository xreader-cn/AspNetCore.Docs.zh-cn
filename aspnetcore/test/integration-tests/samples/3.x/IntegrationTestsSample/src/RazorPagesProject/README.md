# <a name="aspnet-core-integration-testing-sample"></a><span data-ttu-id="3b811-101">ASP.NET Core 集成测试示例</span><span class="sxs-lookup"><span data-stu-id="3b811-101">ASP.NET Core Integration Testing Sample</span></span>
