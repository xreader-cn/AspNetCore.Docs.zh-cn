...
---
# <a name="use-hub-filters-in-aspnet-core-no-locsignalr"></a><span data-ttu-id="02efc-103">在 ASP.NET Core 中使用集线器筛选器 SignalR</span><span class="sxs-lookup"><span data-stu-id="02efc-103">Use hub filters in ASP.NET Core SignalR</span></span>
