...
<span data-ttu-id="f5502-139">`Hub.Context` 还包含以下方法：</span><span class="sxs-lookup"><span data-stu-id="f5502-139">`Hub.Context` also contains the following methods:</span></span>
