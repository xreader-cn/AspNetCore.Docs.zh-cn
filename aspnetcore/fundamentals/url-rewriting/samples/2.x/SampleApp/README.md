# <a name="aspnet-core-url-rewriting-sample"></a><span data-ttu-id="d7709-101">ASP.NET Core URL 重写示例</span><span class="sxs-lookup"><span data-stu-id="d7709-101">ASP.NET Core URL Rewriting Sample</span></span>
