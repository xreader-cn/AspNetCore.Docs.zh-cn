# <a name="aspnet-core-url-rewriting-sample"></a><span data-ttu-id="f756b-101">ASP.NET Core URL 重写示例</span><span class="sxs-lookup"><span data-stu-id="f756b-101">ASP.NET Core URL Rewriting Sample</span></span>
