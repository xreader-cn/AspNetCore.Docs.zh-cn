...
## <a name="use-httpcontext-from-middleware"></a><span data-ttu-id="bd7fa-113">通过中间件使用 HttpContext</span><span class="sxs-lookup"><span data-stu-id="bd7fa-113">Use HttpContext from middleware</span></span>
