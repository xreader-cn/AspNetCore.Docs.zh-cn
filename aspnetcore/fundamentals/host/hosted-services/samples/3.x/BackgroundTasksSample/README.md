# <a name="aspnet-core-background-tasks-sample"></a><span data-ttu-id="75dd4-101">ASP.NET Core 后台任务示例</span><span class="sxs-lookup"><span data-stu-id="75dd4-101">ASP.NET Core Background Tasks Sample</span></span>
