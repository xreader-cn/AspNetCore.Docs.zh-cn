...
---
# <a name="use-aspnet-core-no-locsignalr-with-no-locblazor-webassembly"></a><span data-ttu-id="41398-103">结合使用 ASP.NET Core SignalR 和 Blazor WebAssembly</span><span class="sxs-lookup"><span data-stu-id="41398-103">Use ASP.NET Core SignalR with Blazor WebAssembly</span></span>
...
<span data-ttu-id="41398-105">本教程介绍结合使用 SignalR 和 Blazor WebAssembly 生成实时应用的基础知识。</span><span class="sxs-lookup"><span data-stu-id="41398-105">This tutorial teaches the basics of building a real-time app using SignalR with Blazor WebAssembly.</span></span> <span data-ttu-id="41398-106">您将学习如何：</span><span class="sxs-lookup"><span data-stu-id="41398-106">You learn how to:</span></span>

> [!div class="checklist"]
> * <span data-ttu-id="41398-107">创建 Blazor WebAssembly 托管应用项目</span><span class="sxs-lookup"><span data-stu-id="41398-107">Create a Blazor WebAssembly Hosted app project</span></span>
> * <span data-ttu-id="41398-108">添加 SignalR 客户端库</span><span class="sxs-lookup"><span data-stu-id="41398-108">Add the SignalR client library</span></span>
> * <span data-ttu-id="41398-109">添加 SignalR 集线器</span><span class="sxs-lookup"><span data-stu-id="41398-109">Add a SignalR hub</span></span>
> * <span data-ttu-id="41398-110">添加 SignalR 服务和 SignalR 中心的终结点</span><span class="sxs-lookup"><span data-stu-id="41398-110">Add SignalR services and an endpoint for the SignalR hub</span></span>
> * <span data-ttu-id="41398-111">添加用于聊天的 Razor 组件代码</span><span class="sxs-lookup"><span data-stu-id="41398-111">Add Razor component code for chat</span></span>
...
## <a name="create-a-hosted-no-locblazor-webassembly-app-project"></a><span data-ttu-id="41398-127">创建托管 Blazor WebAssembly 应用项目</span><span class="sxs-lookup"><span data-stu-id="41398-127">Create a hosted Blazor WebAssembly app project</span></span>
...
1. <span data-ttu-id="41398-133">选择“Blazor 应用”，然后选择“下一步”。 </span><span class="sxs-lookup"><span data-stu-id="41398-133">Select **Blazor App** and select **Next**.</span></span>

1. <span data-ttu-id="41398-134">在“项目名称”字段中键入 `BlazorSignalRApp`。</span><span class="sxs-lookup"><span data-stu-id="41398-134">Type `BlazorSignalRApp` in the **Project name** field.</span></span> <span data-ttu-id="41398-135">确认“位置”条目正确无误或为项目提供位置。</span><span class="sxs-lookup"><span data-stu-id="41398-135">Confirm the **Location** entry is correct or provide a location for the project.</span></span> <span data-ttu-id="41398-136">选择“创建”。</span><span class="sxs-lookup"><span data-stu-id="41398-136">Select **Create**.</span></span>

1. <span data-ttu-id="41398-137">选择“Blazor WebAssembly 应用”模板。</span><span class="sxs-lookup"><span data-stu-id="41398-137">Choose the **Blazor WebAssembly App** template.</span></span>
...
1. <span data-ttu-id="41398-149">选择“Blazor WebAssembly 应用”模板。</span><span class="sxs-lookup"><span data-stu-id="41398-149">Choose the **Blazor WebAssembly App** template.</span></span> <span data-ttu-id="41398-150">选择“下一步”。</span><span class="sxs-lookup"><span data-stu-id="41398-150">Select **Next**.</span></span>
...
1. <span data-ttu-id="41398-154">在“项目名称”字段中，将应用命名为 `BlazorSignalRApp`。</span><span class="sxs-lookup"><span data-stu-id="41398-154">In the **Project Name** field, name the app `BlazorSignalRApp`.</span></span> <span data-ttu-id="41398-155">选择“创建”。</span><span class="sxs-lookup"><span data-stu-id="41398-155">Select **Create**.</span></span>
...
## <a name="add-the-no-locsignalr-client-library"></a><span data-ttu-id="41398-161">添加 SignalR 客户端库</span><span class="sxs-lookup"><span data-stu-id="41398-161">Add the SignalR client library</span></span>
...
1. <span data-ttu-id="41398-163">在“解决方案资源管理器”中，右键单击 `BlazorSignalRApp.Client` 项目，然后选择“管理 NuGet 包” 。</span><span class="sxs-lookup"><span data-stu-id="41398-163">In **Solution Explorer** , right-click the `BlazorSignalRApp.Client` project and select **Manage NuGet Packages**.</span></span>
...
1. <span data-ttu-id="41398-165">选择“浏览”后，在搜索框中键入“`Microsoft.AspNetCore.SignalR.Client`”。</span><span class="sxs-lookup"><span data-stu-id="41398-165">With **Browse** selected, type `Microsoft.AspNetCore.SignalR.Client` in the search box.</span></span>

1. <span data-ttu-id="41398-166">在搜索结果中，选中 [`Microsoft.AspNetCore.SignalR.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Client) 包，然后选择“安装”。</span><span class="sxs-lookup"><span data-stu-id="41398-166">In the search results, select the [`Microsoft.AspNetCore.SignalR.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Client) package and select **Install**.</span></span>
...
1. <span data-ttu-id="41398-172">在“解决方案资源管理器”中，右键单击 `BlazorSignalRApp.Client` 项目，然后选择“管理 NuGet 包” 。</span><span class="sxs-lookup"><span data-stu-id="41398-172">In the **Solution** sidebar, right-click the `BlazorSignalRApp.Client` project and select **Manage NuGet Packages**.</span></span>
...
1. <span data-ttu-id="41398-174">选择“浏览”后，在搜索框中键入“`Microsoft.AspNetCore.SignalR.Client`”。</span><span class="sxs-lookup"><span data-stu-id="41398-174">With **Browse** selected, type `Microsoft.AspNetCore.SignalR.Client` in the search box.</span></span>

1. <span data-ttu-id="41398-175">在搜索结果中，选中 [`Microsoft.AspNetCore.SignalR.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Client) 包旁边的复选框，然后选择“添加包”。</span><span class="sxs-lookup"><span data-stu-id="41398-175">In the search results, select the check box next to the [`Microsoft.AspNetCore.SignalR.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Client) package and select **Add Package**.</span></span>
...
## <a name="add-a-no-locsignalr-hub"></a><span data-ttu-id="41398-179">添加 SignalR 集线器</span><span class="sxs-lookup"><span data-stu-id="41398-179">Add a SignalR hub</span></span>

<span data-ttu-id="41398-180">在 `BlazorSignalRApp.Server` 项目中，创建 `Hubs`（复数）文件夹，并添加以下 `ChatHub` 类 (`Hubs/ChatHub.cs`)：</span><span class="sxs-lookup"><span data-stu-id="41398-180">In the `BlazorSignalRApp.Server` project, create a `Hubs` (plural) folder and add the following `ChatHub` class (`Hubs/ChatHub.cs`):</span></span>
...
## <a name="add-services-and-an-endpoint-for-the-no-locsignalr-hub"></a><span data-ttu-id="41398-181">为 SignalR 中心添加服务和终结点</span><span class="sxs-lookup"><span data-stu-id="41398-181">Add services and an endpoint for the SignalR hub</span></span>

1. <span data-ttu-id="41398-182">在 `BlazorSignalRApp.Server` 项目中打开 `Startup.cs` 文件。</span><span class="sxs-lookup"><span data-stu-id="41398-182">In the `BlazorSignalRApp.Server` project, open the `Startup.cs` file.</span></span>
...
1. <span data-ttu-id="41398-184">将 SignalR 和响应压缩中间件服务添加到 `Startup.ConfigureServices`：</span><span class="sxs-lookup"><span data-stu-id="41398-184">Add SignalR and Response Compression Middleware services to `Startup.ConfigureServices`:</span></span>
...
## <a name="add-no-locrazor-component-code-for-chat"></a><span data-ttu-id="41398-188">添加用于聊天的 Razor 组件代码</span><span class="sxs-lookup"><span data-stu-id="41398-188">Add Razor component code for chat</span></span>

1. <span data-ttu-id="41398-189">在 `BlazorSignalRApp.Client` 项目中打开 `Pages/Index.razor` 文件。</span><span class="sxs-lookup"><span data-stu-id="41398-189">In the `BlazorSignalRApp.Client` project, open the `Pages/Index.razor` file.</span></span>
...
> [!div class="checklist"]
> * <span data-ttu-id="41398-226">创建 Blazor WebAssembly 托管应用项目</span><span class="sxs-lookup"><span data-stu-id="41398-226">Create a Blazor WebAssembly Hosted app project</span></span>
> * <span data-ttu-id="41398-227">添加 SignalR 客户端库</span><span class="sxs-lookup"><span data-stu-id="41398-227">Add the SignalR client library</span></span>
> * <span data-ttu-id="41398-228">添加 SignalR 集线器</span><span class="sxs-lookup"><span data-stu-id="41398-228">Add a SignalR hub</span></span>
> * <span data-ttu-id="41398-229">添加 SignalR 服务和 SignalR 中心的终结点</span><span class="sxs-lookup"><span data-stu-id="41398-229">Add SignalR services and an endpoint for the SignalR hub</span></span>
> * <span data-ttu-id="41398-230">添加用于聊天的 Razor 组件代码</span><span class="sxs-lookup"><span data-stu-id="41398-230">Add Razor component code for chat</span></span>

<span data-ttu-id="41398-231">若要了解有关生成 Blazor 应用的详细信息，请参阅 Blazor 文档：</span><span class="sxs-lookup"><span data-stu-id="41398-231">To learn more about building Blazor apps, see the Blazor documentation:</span></span>

> [!div class="nextstepaction"]
> <span data-ttu-id="41398-232"><xref:blazor/index>
> [具有 Identity 服务器、WebSocket 和服务器发送事件的持有者令牌身份验证](xref:signalr/authn-and-authz#bearer-token-authentication)</span><span class="sxs-lookup"><span data-stu-id="41398-232"><xref:blazor/index>
...
* [<span data-ttu-id="41398-234">SignalR 用于身份验证的跨源协商</span><span class="sxs-lookup"><span data-stu-id="41398-234">SignalR cross-origin negotiation for authentication</span></span>](xref:blazor/fundamentals/additional-scenarios#signalr-cross-origin-negotiation-for-authentication)
