...
1. 向 Pages 文件夹中的应用添加一个新的 `Todo` Razor 组件。 如果你使用的是 Visual Studio，请右键单击 Pages 文件夹，然后选择“添加” > “新项目” > “Razor 组件”   。 将组件的文件命名为 Todo.razor。 在其他开发环境中，将空白文件添加到名为 Todo.razor 的“页面”文件夹中。
