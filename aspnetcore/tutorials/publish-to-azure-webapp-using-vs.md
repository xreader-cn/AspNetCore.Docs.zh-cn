...
* <span data-ttu-id="20f12-201">编辑 Pages/Index.cshtml Razor 页并更改其内容。</span><span class="sxs-lookup"><span data-stu-id="20f12-201">Edit the *Pages/Index.cshtml* Razor page and change its contents.</span></span> <span data-ttu-id="20f12-202">例如，可以将段落修改为显示“Hello ASP.NET Core!”：</span><span class="sxs-lookup"><span data-stu-id="20f12-202">For example, you can modify the paragraph to say "Hello ASP.NET Core!":</span></span>
