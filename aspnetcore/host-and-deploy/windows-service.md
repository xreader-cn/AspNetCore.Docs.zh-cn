...
使用 [RegisterService.ps1](https://github.com/aspnet/AspNetCore.Docs/tree/master/aspnetcore/host-and-deploy/windows-service/scripts) PowerShell 脚本来注册服务。 在管理 PowerShell 6 命令行界面中，使用以下命令执行脚本：
